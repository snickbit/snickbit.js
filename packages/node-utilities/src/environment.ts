...
/** @category Environment */
export const user_config_dir: string = os.homedir() + '/.config'
 ...
 * @category Environment
 */
export const interpolateEnv = (str: string, defaultValues: { [key: string]: string } = {}): string => interpolate(str, {...(defaultValues || {}), ...process.env})
